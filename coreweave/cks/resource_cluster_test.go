...
const (
	...
	AcceptanceTestPrefix = "test-acc-cks-"
)
	...
	steps := []resource.TestStep{
		...
		}),
		{
			...
			ConfigStateChecks: []statecheck.StateCheck{
				...
				statecheck.ExpectKnownValue(config.FullDataSourceName, tfjsonpath.New("node_port_range.start"), knownvalue.NotNull()),
				statecheck.ExpectKnownValue(config.FullDataSourceName, tfjsonpath.New("node_port_range.end"), knownvalue.NotNull()),
			},
		},
		createClusterTestStep(ctx, t, testStepConfig{
			TestName: "update",
