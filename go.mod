...
require (
	buf.build/gen/go/coreweave/cks/connectrpc/go v1.19.1-20251031172759-4139872b46cb.2
	buf.build/gen/go/coreweave/cks/protocolbuffers/go v1.36.10-20251031172759-4139872b46cb.1
