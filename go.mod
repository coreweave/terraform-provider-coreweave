...
require (
	...
	buf.build/gen/go/coreweave/networking/connectrpc/go v1.19.2-20260428181559-a139bca827d3.1
	buf.build/gen/go/coreweave/networking/protocolbuffers/go v1.36.11-20260428181559-a139bca827d3.1
