...
require (
	...
	buf.build/gen/go/coreweave/inference/connectrpc/go v1.19.2-20260427194007-0f8bae2ca8ba.1
	buf.build/gen/go/coreweave/inference/protocolbuffers/go v1.36.11-20260427194007-0f8bae2ca8ba.1
