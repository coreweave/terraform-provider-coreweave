...
require (
	...
	buf.build/gen/go/coreweave/networking/connectrpc/go v1.18.0-20250107154908-78de7a31e3e0.1
	buf.build/gen/go/coreweave/networking/protocolbuffers/go v1.36.2-20250107154908-78de7a31e3e0.1
