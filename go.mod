...
require (
	...
	buf.build/gen/go/coreweave/sandbox/connectrpc/go v1.21.0-20260925221003-ceeb53bf347d.1
	buf.build/gen/go/coreweave/sandbox/protocolbuffers/go v1.36.12-20260925221003-ceeb53bf347d.2
