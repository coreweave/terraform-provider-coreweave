...
require (
	...
	buf.build/gen/go/coreweave/networking/connectrpc/go v1.20.0-20260730205312-693dad8eb3dd.1
	buf.build/gen/go/coreweave/networking/protocolbuffers/go v1.36.12-20260730205312-693dad8eb3dd.1
