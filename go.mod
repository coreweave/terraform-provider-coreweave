...
require (
	...
	buf.build/gen/go/coreweave/networking/connectrpc/go v1.18.1-20250304223431-7f67c2bf47a2.1
	buf.build/gen/go/coreweave/networking/protocolbuffers/go v1.36.2-20250304223431-7f67c2bf47a2.1
