...
require (
	...
	buf.build/gen/go/coreweave/networking/connectrpc/go v1.18.1-20250109205650-be691a664218.1
	buf.build/gen/go/coreweave/networking/protocolbuffers/go v1.36.2-20250109205650-be691a664218.1
