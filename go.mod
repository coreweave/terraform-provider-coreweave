...
require (
	...
	buf.build/gen/go/coreweave/networking/connectrpc/go v1.18.1-20250113164612-30a818ba2cd4.1
	buf.build/gen/go/coreweave/networking/protocolbuffers/go v1.36.2-20250113164612-30a818ba2cd4.1
