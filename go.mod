...
require (
	...
	buf.build/gen/go/coreweave/inference/connectrpc/go v1.20.0-20260723213648-c16492d679bc.1
	buf.build/gen/go/coreweave/inference/protocolbuffers/go v1.36.11-20260723213648-c16492d679bc.1
