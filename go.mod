...
require (
	...
	buf.build/gen/go/coreweave/networking/connectrpc/go v1.18.1-20250210163250-c1af6bc56d1a.1
	buf.build/gen/go/coreweave/networking/protocolbuffers/go v1.36.2-20250210163250-c1af6bc56d1a.1
