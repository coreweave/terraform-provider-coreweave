...
require (
	...
	buf.build/gen/go/coreweave/networking/connectrpc/go v1.18.1-20250220181901-b5cccf0c2035.1
	buf.build/gen/go/coreweave/networking/protocolbuffers/go v1.36.2-20250220181901-b5cccf0c2035.1
