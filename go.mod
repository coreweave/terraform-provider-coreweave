...
require (
	...
	buf.build/gen/go/coreweave/networking/connectrpc/go v1.18.1-20250306203755-b7b130adfb3f.1
	buf.build/gen/go/coreweave/networking/protocolbuffers/go v1.36.2-20250306203755-b7b130adfb3f.1
