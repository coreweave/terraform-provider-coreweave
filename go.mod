...
require (
	buf.build/gen/go/coreweave/cks/connectrpc/go v1.18.0-20241219033203-9e6145c6d0ec.1
	buf.build/gen/go/coreweave/cks/protocolbuffers/go v1.36.2-20241219033203-9e6145c6d0ec.1
