...
require (
	...
	buf.build/gen/go/coreweave/cwobject/connectrpc/go v1.19.2-20260316171159-7415169c2287.1
	buf.build/gen/go/coreweave/cwobject/protocolbuffers/go v1.36.11-20260316171159-7415169c2287.1
