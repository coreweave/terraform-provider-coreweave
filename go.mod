...
require (
	buf.build/gen/go/coreweave/cks/connectrpc/go v1.18.1-20250109200057-bb32fdd2ae14.1
	buf.build/gen/go/coreweave/cks/protocolbuffers/go v1.36.2-20250109200057-bb32fdd2ae14.1
