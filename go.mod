...
require (
	...
	buf.build/gen/go/coreweave/workload-federation/connectrpc/go v1.21.0-20260924031013-f0466878f160.1
	buf.build/gen/go/coreweave/workload-federation/protocolbuffers/go v1.36.12-20260924031013-f0466878f160.2
