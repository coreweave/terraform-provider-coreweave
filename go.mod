...
require (
	...
	buf.build/gen/go/coreweave/networking/connectrpc/go v1.18.1-20250131182526-594d7f919898.1
	buf.build/gen/go/coreweave/networking/protocolbuffers/go v1.36.2-20250131182526-594d7f919898.1
