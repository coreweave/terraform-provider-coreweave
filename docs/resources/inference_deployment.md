...
- `gateway_ids` (List of String) The gateway IDs to associate the deployment with. At least one is required.
...
- `capacity_classes` (List of String) Capacity classes to use. Allowed values: "RESERVED", "ON_DEMAND".
